package org.holiday.endpoint;

import java.text.ParseException;
import java.text.SimpleDateFormat;
import java.util.Date;

import org.holiday.entity.Holiday;
import org.holiday.service.HumanResourceService;
...
public class HolidayEndPoint {
	...
	@ResponsePayload
	public Holiday handleHolidayRequest(@RequestPayload Element holidayRequest)
			throws Exception {
		...
		holiday.setEndDate("2006-07-03");
		holiday.setStartDate("2006-07-03");
		holiday.setNameEmployee("XDDDDD");
